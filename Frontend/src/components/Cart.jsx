          ...
          {cartItems.map((item, index) => (
            <tr key={index}>
              ...
              <td className="py-2 px-4 border-b text-center">
                <button className="text-black bg-gray-700  rounded-lg px-[0.4rem] text-2xl"onClick={() => handleDecrement(item)}>-</button>
                <span className="mx-2 text-white">{item.quantity}</span>
                <button className="text-black bg-gray-700  rounded-lg  px-[0.4rem] text-2xl"onClick={() => handleIncrement(item)}>+</button>
              </td>
